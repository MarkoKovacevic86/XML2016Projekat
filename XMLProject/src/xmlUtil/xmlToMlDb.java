...
public class xmlToMlDb {
	...
	public static void xmlToMlDb(ConnectionProperties props, String input, String id, String collection,
			boolean generateUri) throws FileNotFoundException {

		dbc = DatabaseClientFactory.newClient(props.host, props.port, props.database, props.user, props.pass,
				props.authType);
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		String inputFile = "./src/xml/akti/Akt9-test.xml";
		// String inputFile = "data/rdfa/RS26-16-lat_primer_donetog_akta1.xml";
		String docId = "Akt9-test.xml"; // document id
