...
public class AmendmentService {
	...
	public String getAmendments(@PathParam("id") String id) throws IOException {
		...
		String upit = "SELECT * FROM </propisi/amandmani/u_porceduri/metadata> {"
				+ " ?amandman <http://www.parlament.gov.rs/propisi/predicate/oznaka> ?akt ." + "{" + "   SELECT * {"
	...
	public void removeAmendment(Amandman amandman, @PathParam("id") String amId) throws IOException {
		...
		String DocQuery1 = "declare namespace sem=\"http://marklogic.com/semantics\";"
				...
				+ "where $doc/sem:triples/sem:triple[8]/sem:object = \"" + amId + "\"" + "return base-uri($doc)";
	...
	public Response add(Amandman amandman, @PathParam("actId") String actId)
			throws FileNotFoundException, SAXException, JAXBException {
		...
		String xmlPath = "C:\\Users\\Strefa\\git\\XML2016Projekat\\XMLProject\\src\\xml\\akti\\Atemp.xml";
		...
		if (r.getStatus() == 200) {
			try {
				...
				String rdfFilePath = "C:\\Users\\Strefa\\git\\XML2016Projekat\\XMLProject\\rdf\\Atemp.rdf";
				xmlUtil.RDFtoTriples.convert(DBConnection.loadProperties(), xmlPath, rdfFilePath, sparqlNamedGraph,
						grddlPath);
				return r;
	...
	public void changeStatus(@PathParam("id") String id) throws IOException {
		...
		String DocQuery1 = "declare namespace sem=\"http://marklogic.com/semantics\";"
				+ "for $doc in fn:collection(\"/propisi/amandmani/u_porceduri/metadata\")"
				+ "where $doc/sem:triples/sem:triple[8]/sem:object = \"" + id + "\"" + "return base-uri($doc)";

		String r1 = MyXQuery.invoke(DBConnection.loadProperties(), DocQuery1);
		r1 = r1.replace("\n", "");
		String remover1 = "xdmp:document-set-collections(\"" + r1 + "\"" + ",(\"/propisi/amandmani/doneti/metadata\"))";
		MyXQuery.invoke(DBConnection.loadProperties(), remover1);
		...
		String r2 = MyXQuery.invoke(DBConnection.loadProperties(), DocQuery2);
		r2 = r2.replace("\n", "");
		String remover2 = "xdmp:document-set-collections(\"" + r2 + "\"" + ",(\"/propisi/amandmani/doneti/\"))";
		MyXQuery.invoke(DBConnection.loadProperties(), remover2);
	...
	public void allAccepted(@PathParam("idAct") String idAct) throws IOException {
		...
		for (int i = 0; i < 10; i++) {
			...
			String DocQuery1 = "declare namespace sem=\"http://marklogic.com/semantics\";"
					+ "for $doc in subsequence(fn:collection(\"/propisi/amandmani/u_porceduri/metadata\"),1,2)"
					+ "where $doc/sem:triples/sem:triple[3]/sem:object = \"" + idAct + "\"" + "return base-uri($doc)";

			System.out.println(DocQuery1);
			...
			String DocQuery2 = "declare namespace ns6=\"http://www.parlament.gov.rs/propisi/\";"
					+ "for $doc in subsequence(fn:collection(\"/propisi/amandmani/u_proceduri\"),1,1)"
		...
		String DocQuery3 = "declare namespace sem=\"http://marklogic.com/semantics\";"
				...
				+ "where $doc/sem:triples/sem:triple[1]/sem:object = \"" + idAct + "\"" + "return base-uri($doc)";

		System.out.println(DocQuery3);

		String r3 = MyXQuery.invoke(DBConnection.loadProperties(), DocQuery3);
		if (r3 != "") {
			r3 = r3.replace("\n", "");
			String remover3 = "xdmp:document-set-collections(\"" + r3 + "\"" + ",(\"/propisi/akti/doneti/metadata\"))";
		...
		if (r4 != "") {
			r4 = r4.replace("\n", "");
			String remover4 = "xdmp:document-set-collections(\"" + r4 + "\"" + ",(\"/propisi/akti/doneti/\"))";
	...
	@POST
	@Path("addActOnly/{actId}")
	public void addActOnly(@PathParam("actId") String actId) throws IOException	{
		System.out.println(actId);
	
		String DocQuery3 = "declare namespace sem=\"http://marklogic.com/semantics\";"
				+ "for $doc in fn:collection(\"/propisi/akti/u_porceduri/metadata\")"
				+ "where $doc/sem:triples/sem:triple[1]/sem:object = \"" + actId + "\"" + "return base-uri($doc)";
		...
		String DocQuery4 = "declare namespace p=\"http://www.parlament.gov.rs/propisi\";"
				+ "for $doc in fn:collection(\"/propisi/akti/u_proceduri\")"
				+ "where $doc/p:Akt/p:Sporedni_deo/p:Akt_u_proceduri/p:Meta_podaci/p:Oznaka = \"" + actId + "\""
				+ "return base-uri($doc)";
